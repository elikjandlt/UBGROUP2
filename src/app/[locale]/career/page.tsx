    ...
    <>
      ...
      <section className="relative w-full pt-24 pb-16 overflow-hidden bg-[#0F172A]">
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8 text-center">
          ...
          >
            <span className="text-[11px] font-semibold tracking-[0.25em] text-[#C9A227] uppercase mb-6 block">Карьер</span>
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white leading-tight mb-5 tracking-tight">
              Манай багт
              <br />
              <span className="text-[#C9A227]">нэгдээрэй</span>
            </h1>
          </motion.div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <Reveal>
              <div className="bg-[#E8EEF4] rounded-2xl p-4 text-center border border-[#E2E8F0] hover:shadow-lg transition-all duration-500">
                <div className="w-16 h-16 rounded-full bg-[#F5F3ED] flex items-center justify-center mx-auto mb-6">
                  <Briefcase size={28} className="text-[#1E3A5F]" strokeWidth={1.5} />
                </div>
                <h3 className="text-xl font-bold text-[#0F172A] mb-4">Бидэнтэй нэгдэх</h3>
                <p className="text-[#64748B] mb-5">Манай багт нэгдэж, Монгол Улсын хөгжилд хувь нэмрээ оруулаарай.</p>
                <a href="#jobs" className="inline-flex items-center gap-2 px-6 py-3 bg-[#1E3A5F] text-white rounded-lg hover:bg-[#152A45] transition-colors">
            ...
            <Reveal delay={0.1}>
              <div className="bg-[#E8EEF4] rounded-2xl p-4 text-center border border-[#E2E8F0] hover:shadow-lg transition-all duration-500">
                <div className="w-16 h-16 rounded-full bg-[#F5F3ED] flex items-center justify-center mx-auto mb-6">
                  <Handshake size={28} className="text-[#1E3A5F]" strokeWidth={1.5} />
                </div>
                <h3 className="text-xl font-bold text-[#0F172A] mb-4">Хамтран ажиллах</h3>
                <p className="text-[#64748B] mb-5">Тендерт оролцож, хамтран ажиллах боломжоо үзээрэй.</p>
                <a href="#tenders" className="inline-flex items-center gap-2 px-6 py-3 bg-[#1E3A5F] text-white rounded-lg hover:bg-[#152A45] transition-colors">
      ...
      <section id="jobs" className="w-full py-24 bg-[#E8EEF4]">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <Reveal className="text-center mb-5">
            <span className="text-[11px] font-semibold tracking-[0.25em] text-[#1E3A5F] uppercase mb-4 block">Нээлттэй ажлын байр</span>
            <h2 className="text-xl font-bold text-[#0F172A] tracking-tight">Ажлын байрууд</h2>
          </Reveal>
              ...
              <button
                ...
                className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${
                  activeCompany === company
                    ...
                    : "bg-[#F0F4F8] text-[#334155] border border-[#E2E8F0] hover:border-[#1E3A5F]"
                }`}
              >
                {company}
              </button>
              ...
              <Reveal key={job.title} delay={index * 0.1}>
                ...
                >
                  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    ...
                    <button className="px-6 py-3 bg-[#1E3A5F] text-white text-sm font-medium rounded-lg hover:bg-[#152A45] transition-colors shrink-0"
                    >
                      Анкет илгээх
                    </button>
                  </div>
      ...
      <section className="w-full py-24 bg-[#F0F4F8]">
        <div className="mx-auto max-w-3xl px-6 lg:px-8">
          <Reveal className="text-center mb-5">
            <span className="text-[11px] font-semibold tracking-[0.25em] text-[#1E3A5F] uppercase mb-4 block">Анкет илгээх</span>
            <h2 className="text-xl font-bold text-[#0F172A] tracking-tight">Ажлын анкет</h2>
          </Reveal>
          ...
          <Reveal>
            <form className="bg-[#E8EEF4] rounded-2xl p-5 lg:p-4 border border-[#E2E8F0] space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type="text" placeholder="Таны нэр" className="w-full pl-11 pr-4 py-3 bg-[#F0F4F8] border border-[#E2E8F0] rounded-lg focus:outline-none focus:border-[#1E3A5F] text-[15px]" />
                  </div>
                </div>
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type="email" placeholder="Имэйл хаяг" className="w-full pl-11 pr-4 py-3 bg-[#F0F4F8] border border-[#E2E8F0] rounded-lg focus:outline-none focus:border-[#1E3A5F] text-[15px]" />
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type="tel" placeholder="Утасны дугаар" className="w-full pl-11 pr-4 py-3 bg-[#F0F4F8] border border-[#E2E8F0] rounded-lg focus:outline-none focus:border-[#1E3A5F] text-[15px]" />
                  </div>
                </div>
                <div>
                  <label className="text-sm text-[#64748B] mb-2 block">Ажлын байр</label>
                  <select className="w-full px-4 py-3 bg-[#F0F4F8] border border-[#E2E8F0] rounded-lg focus:outline-none focus:border-[#1E3A5F] text-[15px]">
              ...
              <div>
                ...
                <textarea rows={4} placeholder="Өөрийгөө товч танилцуулна уу" className="w-full px-4 py-3 bg-[#F0F4F8] border border-[#E2E8F0] rounded-lg focus:outline-none focus:border-[#1E3A5F] text-[15px] resize-none"></textarea>
              </div>

              <div>
                <label className="text-sm text-[#64748B] mb-2 block">CV хавсаргах</label>
                <div className="border-2 border-dashed border-[#E2E8F0] rounded-lg p-5 text-center hover:border-[#1E3A5F] transition-colors cursor-pointer">
                  <Upload size={24} className="mx-auto mb-2 text-[#94A3B8]" />
                  <p className="text-sm text-[#64748B]">Файл чирж оруулах эсвэл дарна уу</p>
                </div>
              </div>

              <button type="submit" className="w-full flex items-center justify-center gap-2 px-8 py-4 bg-[#1E3A5F] text-white font-semibold rounded-lg hover:bg-[#152A45] transition-colors"
              >
                <Send size={18} />
                Анкет илгээх
              </button>
      ...
      <section id="tenders" className="w-full py-24 bg-[#E8EEF4]">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <Reveal className="text-center mb-5">
            <span className="text-[11px] font-semibold tracking-[0.25em] text-[#1E3A5F] uppercase mb-4 block">Нээлттэй тендер</span>
            <h2 className="text-xl font-bold text-[#0F172A] tracking-tight">Тендерүүд</h2>
          </Reveal>
            ...
            {tenders.map((tender, index) => (
              <Reveal key={tender.title} delay={index * 0.1}>
                ...
                >
                  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    <div>
                      <h3 className="text-xl font-semibold text-[#0F172A] mb-2">{tender.title}</h3>
                      <div className="flex flex-wrap gap-4 text-sm text-[#64748B]">
      ...
      <section className="w-full py-24 bg-[#F0F4F8]">
        <div className="mx-auto max-w-3xl px-6 lg:px-8">
          <Reveal className="text-center mb-5">
            <span className="text-[11px] font-semibold tracking-[0.25em] text-[#1E3A5F] uppercase mb-4 block">Тендерт оролцох</span>
            <h2 className="text-xl font-bold text-[#0F172A] tracking-tight">Тендерийн хүсэлт</h2>
          </Reveal>
            ...
            <form className="bg-[#E8EEF4] rounded-2xl p-5 lg:p-4 border border-[#E2E8F0] space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="text" placeholder="Компанийн нэр" className="w-full px-4 py-3 bg-[#F0F4F8] border border-[#E2E8F0] rounded-lg focus:outline-none focus:border-[#1E3A5F] text-[15px]" />
                </div>
                <div>
                  <label className="text-sm text-[#64748B] mb-2 block">Бүртгэлийн дугаар</label>
                  <input type="text" placeholder="РД" className="w-full px-4 py-3 bg-[#F0F4F8] border border-[#E2E8F0] rounded-lg focus:outline-none focus:border-[#1E3A5F] text-[15px]" />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="text" placeholder="Холбогдох хүн" className="w-full px-4 py-3 bg-[#F0F4F8] border border-[#E2E8F0] rounded-lg focus:outline-none focus:border-[#1E3A5F] text-[15px]" />
                </div>
                <div>
                  <label className="text-sm text-[#64748B] mb-2 block">Утас</label>
                  <input type="tel" placeholder="Утасны дугаар" className="w-full px-4 py-3 bg-[#F0F4F8] border border-[#E2E8F0] rounded-lg focus:outline-none focus:border-[#1E3A5F] text-[15px]" />
                </div>
              </div>
